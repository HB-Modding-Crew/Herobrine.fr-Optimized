...
copy_file(cf_path + "options.txt", mmc_path + ".minecraft/options.txt", "CurseForge options.txt", "MultiMC")
...
copy_file(cf_path + "options.txt", packwiz_path + "/options.txt", "CurseForge options.txt", "Git (Packwiz)")
